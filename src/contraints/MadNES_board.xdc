...
set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports clk]
create_clock -period 10.000 -name clk_100m [get_ports clk]

## EBI

set_property -dict {PACKAGE_PIN A13 IOSTANDARD LVCMOS33} [get_ports {div_clk[0]}]
set_property -dict {PACKAGE_PIN B12 IOSTANDARD LVCMOS33} [get_ports {div_clk[1]}]
set_property -dict {PACKAGE_PIN A12 IOSTANDARD LVCMOS33} [get_ports {div_clk[2]}]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports {div_clk[3]}]
set_property -dict {PACKAGE_PIN A15 IOSTANDARD LVCMOS33} [get_ports {div_clk[4]}]
set_property -dict {PACKAGE_PIN B14 IOSTANDARD LVCMOS33} [get_ports {div_clk[5]}]
set_property -dict {PACKAGE_PIN C16 IOSTANDARD LVCMOS33} [get_ports {div_clk[6]}]
set_property -dict {PACKAGE_PIN C14 IOSTANDARD LVCMOS33} [get_ports {div_clk[7]}]
set_property -dict {PACKAGE_PIN B16 IOSTANDARD LVCMOS33} [get_ports {div_clk[8]}]
set_property -dict {PACKAGE_PIN B10 IOSTANDARD LVCMOS33} [get_ports {div_clk[9]}]
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports {div_clk[10]}]
set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS33} [get_ports {div_clk[11]}]
set_property -dict {PACKAGE_PIN B9 IOSTANDARD LVCMOS33} [get_ports {div_clk[12]}]
set_property -dict {PACKAGE_PIN C9 IOSTANDARD LVCMOS33} [get_ports {div_clk[13]}]
set_property -dict {PACKAGE_PIN D9 IOSTANDARD LVCMOS33} [get_ports {div_clk[14]}]
set_property -dict {PACKAGE_PIN D8 IOSTANDARD LVCMOS33} [get_ports {div_clk[15]}]

set_property -dict {PACKAGE_PIN C8 IOSTANDARD LVCMOS33} [get_ports {div_clk[16]}]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports {div_clk[17]}]
set_property -dict {PACKAGE_PIN A8 IOSTANDARD LVCMOS33} [get_ports {div_clk[18]}]
set_property -dict {PACKAGE_PIN A14 IOSTANDARD LVCMOS33} [get_ports {div_clk[19]}]

set_property -dict {PACKAGE_PIN C11 IOSTANDARD LVCMOS33} [get_ports {div_clk[20]}]
set_property -dict {PACKAGE_PIN E12 IOSTANDARD LVCMOS33} [get_ports {div_clk[21]}]
set_property -dict {PACKAGE_PIN E11 IOSTANDARD LVCMOS33} [get_ports {div_clk[22]}]

## SPI MCU

set_property -dict {PACKAGE_PIN E13 IOSTANDARD LVCMOS33} [get_ports {div_clk[23]}]
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33} [get_ports {div_clk[24]}]
...
#RED CHANNEL
set_property -dict {PACKAGE_PIN C3 IOSTANDARD LVCMOS33} [get_ports {div_clk[77]}]
set_property -dict {PACKAGE_PIN B1 IOSTANDARD LVCMOS33} [get_ports {div_clk[78]}]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports {div_clk[79]}]
set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports {div_clk[80]}]
set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS33} [get_ports {div_clk[81]}]

#GREEN CHANNEL
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports {div_clk[82]}]
set_property -dict {PACKAGE_PIN B2 IOSTANDARD LVCMOS33} [get_ports {div_clk[83]}]
set_property -dict {PACKAGE_PIN C1 IOSTANDARD LVCMOS33} [get_ports {div_clk[84]}]
set_property -dict {PACKAGE_PIN D1 IOSTANDARD LVCMOS33} [get_ports {div_clk[85]}]
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports {div_clk[86]}]
set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33} [get_ports {div_clk[87]}]

#BLUE CHANNEL
set_property -dict {PACKAGE_PIN A2 IOSTANDARD LVCMOS33} [get_ports {div_clk[88]}]
set_property -dict {PACKAGE_PIN C2 IOSTANDARD LVCMOS33} [get_ports {div_clk[89]}]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports {div_clk[90]}]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports {div_clk[91]}]
set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33} [get_ports {div_clk[92]}]

#SYNC

set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports {div_clk[93]}]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports {div_clk[94]}]
...
set_property -dict {PACKAGE_PIN D10 IOSTANDARD LVCMOS33} [get_ports {div_clk[162]}]
