...
# Create project
create_project ${_xil_proj_name_} $origin_dir/vivado_project -part xc7a100tftg256-3 -quiet -force
...
set files [list \
 ...
 [file normalize "${origin_dir}/src/design/interrupt_gen.sv"] \
...
set file "$origin_dir/src/design/display_timings.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/design/ebi_interface.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/design/interrupt_gen.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/src/design/tam_memory.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/src/design/vram_sprite_memory.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$origin_dir/src/design/simple_ram.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "[file normalize "$origin_dir/src/contraints/arty.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/contraints/arty.xdc"
set file [file normalize $file]
...
# Create 'MadNes_Board' fileset (if not found)
if {[string equal [get_filesets -quiet MadNes_Board] ""]} {
  create_fileset -constrset MadNes_Board
}

# Set 'MadNes_Board' fileset object
set obj [get_filesets MadNes_Board]

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/src/contraints/MadNES_board.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/contraints/MadNES_board.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets MadNes_Board] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Set 'MadNes_Board' fileset properties
set obj [get_filesets MadNes_Board]
set_property -name "target_part" -value "xc7a100tftg256-3" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/src/testbench/top_test_tb.sv"] \
 [file normalize "${origin_dir}/src/testbench/ebi_interface_tb.sv"] \
 [file normalize "${origin_dir}/src/testbench/interrupt_gen_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/src/testbench/top_test_tb.sv"
set file [file normalize $file]
...
set file "$origin_dir/src/testbench/interrupt_gen_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "top" -value "top_test_tb" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
# Create 'Devboard' run (if not found)
if {[string equal [get_runs -quiet Devboard] ""]} {
    create_run -name Devboard -part xc7a35ticsg324-1L -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs Devboard]
  set_property flow "Vivado Synthesis 2020" [get_runs Devboard]
}
set obj [get_runs Devboard]
set_property set_report_strategy_name 1 $obj
set_property report_strategy {Vivado Synthesis Default Reports} $obj
set_property set_report_strategy_name 0 $obj
# Create 'Devboard_synth_report_utilization_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs Devboard] Devboard_synth_report_utilization_0] "" ] } {
  create_report_config -report_name Devboard_synth_report_utilization_0 -report_type report_utilization:1.0 -steps synth_design -runs Devboard
}
set obj [get_report_configs -of_objects [get_runs Devboard] Devboard_synth_report_utilization_0]
if { $obj != "" } {
...
# Create 'MADNes_Board' run (if not found)
if {[string equal [get_runs -quiet MADNes_Board] ""]} {
    create_run -name MADNes_Board -part xc7a100tftg256-3 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset MadNes_Board
} else {
  set_property strategy "Vivado Synthesis Defaults" [get_runs MADNes_Board]
  set_property flow "Vivado Synthesis 2020" [get_runs MADNes_Board]
}
set obj [get_runs MADNes_Board]
set_property set_report_strategy_name 1 $obj
set_property report_strategy {Vivado Synthesis Default Reports} $obj
set_property set_report_strategy_name 0 $obj
# Create 'MADNes_Board_synth_report_utilization_0' report (if not found)
if { [ string equal [get_report_configs -of_objects [get_runs MADNes_Board] MADNes_Board_synth_report_utilization_0] "" ] } {
  create_report_config -report_name MADNes_Board_synth_report_utilization_0 -report_type report_utilization:1.0 -steps synth_design -runs MADNes_Board
}
set obj [get_report_configs -of_objects [get_runs MADNes_Board] MADNes_Board_synth_report_utilization_0]
if { $obj != "" } {
...
current_run -synthesis [get_runs MADNes_Board]

# Create 'impl_2' run (if not found)
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7a100tftg256-3 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset MadNes_Board -parent_run MADNes_Board
} else {
